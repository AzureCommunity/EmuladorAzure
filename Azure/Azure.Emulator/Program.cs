...
namespace Azure
{
    ...
    internal class Program
    {
        ...
        {
            Console.Clear();
            @Console.SetWindowSize(Console.LargestWindowWidth > 149 ? 150 : Console.WindowWidth,
                Console.LargestWindowHeight > 49 ? 50 : Console.WindowHeight);
            Console.SetCursorPosition(0, 0);
            Console.ForegroundColor = ConsoleColor.Black;
            Console.WriteLine();
            Console.WriteLine(@"     " + @" Emulador Azure V0.1 ");
            Console.WriteLine(@"     " + @" Emulador editado para Open Source ");
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine(@"     " + @" OPEN SOURCE");
            Console.WriteLine();
